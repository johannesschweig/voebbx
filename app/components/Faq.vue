...
const faqs = [
  {
    ...
    answer: 'Zwischen deinem Kiez und der Bibliothek. Standard ist die PLZ 10178 (Mitte). Du kannst deine eigene PLZ ganz einfach in den Einstellungen der Merkliste hinterlegen, sobald du ein kostenloses Konto hast.'
  },
  {
